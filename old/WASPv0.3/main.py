...
labelTitle.grid(row=0, column=0, columnspan=1, pady=15)

# Description of the software tool.
labelDesc = tk.Label(root,
                text="This tool allows you to view and update metrics for each STW and generate reports to validate published PE, DWF and FFT figures. ",
                font=("Helvetica", 12))
